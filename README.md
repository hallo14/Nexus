...
You can find a copy of the LGPLv3 at https://www.gnu.org/licenses/lgpl-3.0.html.

The Qt source code can be obtained from https://www.qt.io/download.

Note on Relinkability: In compliance with the LGPL, this application is distributed using shared linking (dynamic libraries). This allows users to replace the Qt libraries with their own versions if they wish.
